  ...
  >
    <div class="relative">
      ...
      <div class="float-left w-7 h-7 leading-3 ml-7 mt-2 player-scrub">
        ...
        >
          <span class="song-title font-bold" v-text="currentSong.modified_name" /> by
          <span class="song-artist" v-text="currentSong.display_name" />
        </div>
        <!-- Scrub Container  -->
        <span
...
export default {
  computed: {
    ...
    ...mapState('player', ['duration', 'seek', 'playerProgress', 'currentSong'])
  },
  methods: {
